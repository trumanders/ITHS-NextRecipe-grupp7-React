...
const nailSoupInfo = {
  ...
  instructions:
    "Boil water, and then add the nail. Meanwhile stirring, ask the old woman if she wouldn´t like her soup to taste even better. With just a pinch of herbs and some onion and garlic. Cook over a medium-low heat for a few minutes, then tell the old woman that the soup tastes fantastic. But wouldn´t it be great if it could be even better? With just a few potatoes and carrots, that could be done. Now, the soup is truely amazing. Perhaps... perhaps could we make this wonderful nail soup something that people would talk about for generations? All we need is one of your chickens...",
