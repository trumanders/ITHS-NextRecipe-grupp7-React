...
const ApiKey = '096ade3d0b09415ab81cb1753100db89';
...
export default function Recipe(){
    ...
    async function getRecipeById() {
        const recipeArray = [];
        const response = await fetch(`https://api.spoonacular.com/recipes/715424/information`, {
            headers: {
    ...
    async function getNutritionsById() {
        const nutritionsArray = [];
        const response = await fetch(`https://api.spoonacular.com/recipes/715424/nutritionWidget.json`, {
            headers: {
                'Content-Type': 'application/json',
                'X-Api-Key': `${ApiKey}`
            }
        ...
        nutritionsArray.push(data);
    
        
        // console.log(nutritionsArray);
        setNutritions(nutritionsArray);
    }
    ...
    // useEffect(() => {
    //     const recept = [];
    //     fetch('https://api.spoonacular.com/recipes/715424/information', {
    //     headers: {
    //         'Content-Type': 'application/json',
    //         'X-Api-Key': `${ApiKey}`
    //     }
    ...
    // useEffect(() => {
    //     const nutri = [];
    //     fetch('https://api.spoonacular.com/recipes/715424/nutritionWidget.json', {
    //     headers: {
    //         'Content-Type': 'application/json',
    //         'X-Api-Key': `${ApiKey}`
    //     }
    ...
    // console.log(recipe);
    // console.log('The nutritions are');
    // console.log(nutritions);
